function change_description()
{
	...
	check_token("//" + api_host + "/change_description?description_64=" + btoa(String.fromCodePoint(...(new TextEncoder().encode(description_value)))), {method: "POST"}, function(response) {
